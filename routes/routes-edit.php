    ...
    <div class="routes-edit-page-container">
          ...
          <div class="route-create">
              ...
              <div class="route-point-add">
                 <a href="#" id="route-point-add-address"><span class="glyphicon glyphicon-plus-sign"></span>&nbspAdd Address&nbsp</a>
                 <a href="#" id="route-point-add-marker"><span class="glyphicon glyphicon-map-marker"></span>&nbspAdd Point&nbsp</a>                 
                 <a href="#" id="route-point-add-close"><span class="glyphicon glyphicon-ok"></span>&nbspClose Loop&nbsp</a>
              </div>
